...
namespace GoogleMobileAds.Editor
{
    internal class GoogleMobileAdsSettings : ScriptableObject
    {
        ...
        [SerializeField]
        private string adMobAndroidAppId = "ca-app-pub-8822822499150620~8161842966";

        [SerializeField]
        private string adMobIOSAppId = "ca-app-pub-8822822499150620~1354544428";

        [SerializeField]
        private bool delayAppMeasurementInit;

        [SerializeField]
        private bool optimizeInitialization = true;

        [SerializeField]
        private bool optimizeAdLoading = true;

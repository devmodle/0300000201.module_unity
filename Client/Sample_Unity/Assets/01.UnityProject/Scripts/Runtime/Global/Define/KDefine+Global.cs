...
public static partial class KDefine {
	...
	public static readonly Dictionary<string, (string, int)> G_TABLE_INFO_GOOGLE_SHEET_DICT = new Dictionary<string, (string, int)>() {
		...
		[Path.GetFileNameWithoutExtension(KCDefine.U_TABLE_P_G_ETC_INFO)] = ("18LvXIUoIet_NT1m5SGyu-fAOoG0UAYVFjlE6rk7rULs", KCDefine.U_MAX_NUM_GOOGLE_SHEET_CELLS_AT_ONCE * 4),
